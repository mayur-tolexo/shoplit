...
export default async function FollowingFeedPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 sm:px-6 py-10 pb-24 sm:pb-10">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="font-serif text-3xl sm:text-4xl tracking-tight leading-none">Your feed</h1>
          <p className="text-sm text-muted mt-1">New carts from creators you follow.</p>
        </div>
      </div>
